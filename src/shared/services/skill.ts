...
export function generateSkillMd(
  ...
  const intro = [
    ...
    "`hyd` unfound, use `python -m hypha_debugger.cli` instead (same args). The raw HTTP API",
    "below still works and powers the CLI. (Replace `{SERVICE_URL}`",
    "with this service's URL — the one you fetched this document from, minus `/get_skill_md`.)",
    "",
